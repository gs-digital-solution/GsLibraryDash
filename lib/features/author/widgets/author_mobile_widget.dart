                ...
                children: [
                  ...
                  Column(
                      ...
                      children: List.generate(
                          list.length,
                              (index) {
                            TopAuthors authorModel = list[index];
                            bool cell = true;
                            return
                                    Obx(() {
                                          if (queryText.value.isNotEmpty &&
                                              !authorModel.firstname!.toLowerCase().contains(queryText.value)) {
                                            cell =
                                            false;
                                          }
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: ClipRRect(
                                                          ...
                                                          child: Image(
                                                            width: 50.h,
                                                            height: 50.h,
                                                            image: NetworkImage(authorModel.avatar!.url ?? ""),
                                                            fit: BoxFit.cover,
                                                          ),
                                                        ),
                                                      ),
