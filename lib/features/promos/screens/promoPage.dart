...
class _PromoScreenState extends State<PromoScreen> {
    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(context, 'Promo', 75, getFontColor(context),
  ...
  _showPopupMenu(BuildContext context, var detail, Promo storyModel) async {
      ...
      items: [
        ...
        PopupMenuItem<String>(
            ...
            onTap: () {
              getCommonDialog(
                  context: context,
                  title: 'Voulez-vous supprimer ce Code promo?',
                  function: () {
  ...
  getActiveDeActiveCell(BuildContext context, bool isActive, Promo storyModel) {
    return InkWell(
      child: Container(
          width: 120.h,
          alignment: Alignment.centerLeft,
  ...
  updateStatus(BuildContext context, Promo storyModel) {
    getCommonDialog(
        context: context,
        title: storyModel.active!.value
            ? 'Voulez-vous desactiver ce code promo?'
            : 'Voulez-vous activer ce code promo?',
        function: () {
          storyModel.active!.value = !storyModel.active!.value;
