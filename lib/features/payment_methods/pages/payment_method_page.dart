...
class _PaymentMethodPageState extends State<PaymentMethodPage> {
  ...
  RxInt ind = 0.obs;
  final PaymentMethodController countryController =
    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(
                context, 'Methode de paiement', 75, getFontColor(context),
                      ...
                      children: [
                        ...
                        countryController.obx(
                          (state) => Obx(() {
                            ...
                            List<PaymentMethod> paginationList = [];
  ...
  _showPopupMenu(
      BuildContext context, var detail, PaymentMethod storyModel) async {
      ...
      items: [
        ...
        PopupMenuItem<String>(
            ...
            onTap: () {
              getCommonDialog(
                  context: context,
                  title: 'Voulez-vous supprimer cette methode de paiement?',
                  function: () {
  ...
  getActiveDeActiveCell(
      BuildContext context, bool isActive, PaymentMethod storyModel) {
    return InkWell(
      child: Container(
          width: 120.h,
          alignment: Alignment.centerLeft,
  ...
  updateStatus(BuildContext context, PaymentMethod storyModel) {
    getCommonDialog(
        context: context,
        title: storyModel.isActivated!.value
            ? 'Voulez-vous desactiver cette methode de paiement'
            : 'Voulez-vous activer cette methode de paiement?',
        function: () {
          storyModel.isActivated!.value = !storyModel.isActivated!.value;
          countryController.updatePromoStatus(promo: storyModel);
        },
        subTitle: 'Methode de paiement');
  }
}
