                            ...
                            child: Row(
                              children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image(
                                        ...
                                        height: 50.h,
                                        image: NetworkImage(
                                            list[index].investor!.avatar!.url ??
                                                ""),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                ...
                                getHeaderCell(
                                    ...
                                    150),
                                getHorSpace(10.h),
                                getHeaderCell('${list[index].solde ?? ""} XAF',
                                    context, 150),
                                getHorSpace(10.h),
                                Expanded(
                                  flex: 1,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          getHeaderCell('Nom & Prenom', context, 200),
          getHeaderCell('Pourcentage', context, 150),
          getHeaderCell('Solde GSLIBRARY', context, 150),
          getHeaderCell('Solde', context, 150),
          getHorSpace(10.h),
          Expanded(child: getHeaderTitle(context, 'Date Investissement')),
          Expanded(
              child: getHeaderTitle(context, 'Date Cloture Investissement')),
          /* getHeaderCell(
              'Status',
              context,
              120), */
